<?php /* $Id: config.php,v 1.1 2009-05-19 21:15:30 pkerestezachi Exp $ */
...
// local settings
$dPconfig['root_dir'] = "/var/www/htdocs/proficient5.tfsla.com";  // No trailing slash
...
$dPconfig['base_url'] = "http://www5.tfsla.com";
$dPconfig['site_domain'] = "www5.tfsla.com";
$dPconfig['smtphost'] = "127.0.0.1";
$dPconfig['mailfrom'] = "ctobares@tfsla.com";
$dPconfig['instanceprefix'] = "php5tfslacom"; 
...
// HHRR Settings
// BackEnd 
$dPconfig['company_hhrr_mail'] = "ctobares@tfsla.com";
...
$dPconfig['adminmail'] = "ctobares@tfsla.com";
$dPconfig['webmastermail'] = "ctobares@tfsla.com";
...
$dPconfig["todo_mail"] = "proficient_beta_asdfghjkl_qwertyuiop@tfsla.com";
$dPconfig["opportunity_mail"] = "proficient_beta_asdfghjkl_qwertyuiop@tfsla.com";


// Cantidad de dias a mostrar en MIS ASIGNACIONES por defecto
$dPconfig['days_myassignments'] = 30;

// Directorio para importacion de tareas en proyectos
$dPconfig['tasks_uploads_dir'] = "./files/tasks";
