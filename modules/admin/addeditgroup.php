...
<table width="95%" border="0" cellpadding="0" cellspacing="1">
    <tr>
    <td valign="top"><img src="./images/icons/admin.gif" alt="" border="0" width="32" height="32" /></td>
...
<form name="changeuser" action="./index.php?m=admin&a=dosql" method="post">
    ...
    <tr><td align="right"><?=$AppUI->_('IM Type');?>:</td><td><?=arraySelect( $IMtypes, 'user_im_type', 'size="1" class="text"', @$prow["user_im_type"], true )."&nbsp;".$AppUI->_('IM Id');?>: <input type="text" class="text" name="user_im_id" value="<?php echo $prow["user_im_id"];?>" maxlength="40" /> </td></tr>
