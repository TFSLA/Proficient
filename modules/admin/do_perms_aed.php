...
$AppUI->setMsg( $AppUI->_('Permissions'));
...
if ($del) {
	...
	if (($msg = $obj->store())) {
		...
		//Fix: Si se da de alta "projects", también tiene que cargarse "myassigments".
		switch($obj->permission_grant_on)
		{
			case "projects":
				$obj->permission_id = 0;
				$obj->permission_grant_on = "myassigments";
				$obj->store();
				break;
		}		
