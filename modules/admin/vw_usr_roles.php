<?php /* ADMIN $Id: vw_usr_roles.php,v 1.1 2009-05-19 21:15:41 pkerestezachi Exp $ */
...
function popPermItem() {
	...
	window.open('./index.php?m=public&a=selector&dialog=1&suppressLogo=1&callback=setPermItem&table=' + tables[pgo], 'selector', 'left=50,top=50,height=250,width=400,resizable')
}
