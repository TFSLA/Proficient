<?php /* CALENDAR $Id: vw_day_tasks.php,v 1.1 2009-05-19 21:15:42 pkerestezachi Exp $ */
global $this_day, $first_time, $last_time, $company_id, $project_id, $m, $a;

$links = array();
// assemble the links for the tasks
require_once( $AppUI->getConfig( 'root_dir' )."/modules/calendar/links_tasks.php" );
getTaskLinks( $first_time, $last_time, $links, 100, $company_id, $project_id, true );
