<?php /* CONTACTS $Id: add_contact.php,v 1.3 2009-07-29 16:54:56 nnimis Exp $ */
...
$titleBlock = new CTitleBlock( $ttl, 'handshake.gif', $m, "colaboration.index" );
...
<tr>
	<td valign="top">
		...
		<tr>	
			...
			{
			?>			
				:</td><td><input <?=$ro?> type="checkbox" value="1" onclick="duplicado();" name="contact_public" checked disabled />
			<?
			}
			else
			{			
...
<tr>
	<td valign="top" width="50%">
		...
		<tr>
			...
			<td nowrap>
				<input <?=$ro?> type="text" class="text" name="contact_company" value="<?php echo @$_GET['company_name']?>" maxlength="100" size="25" />
		...
		<tr>
			...
			<input type="text" name="birthday" maxlength="10" size="12" value="" class="text" disabled="disabled">
