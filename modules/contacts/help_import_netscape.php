<?php /* CONTACTS $Id: help_import_netscape.php,v 1.1 2009-05-19 21:15:42 pkerestezachi Exp $ */
...
$titleBlock = new CTitleBlock( "Import contacts from Netscape", 'contacts.gif', $m, "$m.$a" );
...
<table>
	<tr>
		<td colspan="2">
			<?php echo $AppUI->_('In order to transfer contact information from Yahoo! to PSA you have to perform the following operations').":";?>
		</td>		
	</tr>
	<tr>
		<td>1.</td>
		<td><?php echo $AppUI->_('Open Netscape Communicator')?>.</td>
	</tr>
	<tr>
		<td>2.</td>
		<td><?php echo $AppUI->_('On the Communicator menu select Address Book')?>.</td>
	</tr>
	<tr>
		<td>3.</td>
		<td><?php echo $AppUI->_('On the Address book window, inside File menu, select "Save as"')?>.</td>
	</tr>
	<tr>
		<td>4.</td>
		<td><?php echo $AppUI->_('Select an easy to remember name which ends in .LDIF and a location to save the file. Press the Save button')?>.</td>
	</tr>
	<tr>
		<td>5.</td>
	...
	<tr>
		<td>7.</td>
		<td><?php echo $AppUI->_('On the import section, select "Netscape"')?>.</td>
	</tr>
	<tr>
		<td>8.</td>
