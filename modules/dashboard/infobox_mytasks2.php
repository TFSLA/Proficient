...
<tr class="tableHeaderGral">
	<td width="20" colspan="2"><?php echo $AppUI->_('Progress');?></td>
	<td width="15" align="center"><?php echo $AppUI->_('P');?></td>
	<td colspan="2" align="center"><?php echo $AppUI->_('Task / Project');?></td>
	<td nowrap><?php echo $AppUI->_('Start Date');?></td>
	<td nowrap><?php echo $AppUI->_('Duration');?></td>
	<td nowrap><?php echo $AppUI->_('Finish Date');?></td>
	<td nowrap><?php echo $AppUI->_('Due In');?></td>
</tr>
