<?php /* DEPARTMENTS $Id: departments.class.php,v 1.1 2009-05-19 21:15:42 pkerestezachi Exp $ */
##
## CDepartment Class
##
...
class CDepartment {
	...
	function check() 
	{			
		if ( $this->dept_id == $this->dept_parent && $this->dept_id ) 
		{
	...
	function delete() {
		...
		$sql = "SELECT user_id FROM users WHERE user_department = $this->dept_id;";
		$res = db_exec( $sql );
		if (db_num_rows( $res )) {
