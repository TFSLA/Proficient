<?php /* $Id: addedit.php,v 1.1 2009-05-19 21:15:44 pkerestezachi Exp $ */
...
<tr>
	<td width="50%" align="right">
		<a href="javascript:delIt()"><img align="absmiddle" src="./images/icons/trash.gif" width="20" height="20" alt="" border="0"><?php echo $AppUI->_('delete history');?></a>
	</td>
</tr>
</table>
