<?php /* HISTORY $Id: index.php,v 1.1 2009-05-19 21:15:44 pkerestezachi Exp $ */
##
## History module
## (c) Copyright
...
?>
<tr>	
	<td><a href='<?php echo "?m=history&a=addedit&history_id=" . $row["history_id"] ?>'><img src="./images/icons/edit_small.gif" alt="<?php echo $AppUI->_( 'Edit History' ) ?>" border="0" width="20" height="20"></a></td>
