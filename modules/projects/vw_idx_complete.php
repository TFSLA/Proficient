<?php /* PROJECTS $Id: vw_idx_complete.php,v 1.2 2009-07-27 14:13:29 nnimis Exp $ */
...
<?php
global $sql;
$sql = str_replace("project_status = project_status", 
					"project_active > 0 AND (
					project_percent_complete >= 100 OR
					project_status = 5)", $sql);
//echo "<br>$sql<br>";
$dp = new DataPager($sql, "com");
