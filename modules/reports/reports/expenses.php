...
$projectId = dPgetParam( $_POST, "projectId", 0 );
...
function canal_project(company, canal, project, user )
{
    ...
    xajax_addProjects(company, canal, project, 'FALSE', '', '', 'projectId' );
    xajax_addUsersProjects('user_id', project ,canal ,company , user );
}
      
function submitIt()
{
	if (document.editFrm.projectId.value !="")
	{
...
<script type="text/javascript">
    canal_project(document.editFrm.company_id.value, '<?=$canal_id?>', '<?=$projectId?>','<?=$user_id ?>' );			
</script>
   ...
   <td  >
		<select name="projectId" id="projectId" onchange="canal_project(document.editFrm.company_id.value, document.editFrm.canal_id.value, document.editFrm.projectId.value,'' );"; style="font-size:10px; width: 160px; "></select>
   </td>
   ...
   <td >
		<select name="user_id" id="user_id" style="font-size:10px; width: 160px">
		</select>
   </td>
</tr>
