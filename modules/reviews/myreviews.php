<?php /* $Id: myreviews.php,v 1.1 2009-05-19 21:15:45 pkerestezachi Exp $ */
$AppUI->savePlace();
...
<tr>
  <th><?=$AppUI->_('My Reviews')?>:</th>
</tr>
<tr>
  <td><ul>
<?
$sql = "SELECT review_id, user_id, producttitle, review, score, relatedlink, linktitle, DATE_FORMAT(date,'%m/%d/%Y') as datefmt FROM reviews WHERE reviews.user_id={$AppUI->user_id} AND producttitle LIKE '$initial%' ORDER BY date DESC ";
