...
if ($p_user_type=="1"){
	...
	$user_id = $p_permission_user;
}

if ($del){
	$obj->setPermission($p_task_project, $user_id, $p_access_id, $p_item_id, 0);
}else{
	$obj->setPermission($p_task_project, $user_id, $p_access_id, $p_item_id, $p_permission_value);
}
