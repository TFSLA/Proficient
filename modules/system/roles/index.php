<?php /* ROLES $Id: index.php,v 1.1 2009-05-19 21:15:46 pkerestezachi Exp $ */
$AppUI->savePlace();
...
$titleBlock = new CTitleBlock( 'Roles', 'administration.jpg', $m, "$m.$a" );
...
function showRow( $role=null ) {
	...
	// edit form
		...
		if ($canEdit) {
			$s .= '<a href="?m=system&u=roles&role_id='.$id.'"><img src="./images/icons/edit_small.gif" alt="edit" border="0" width="20" height="20"></a>';
			$s .= '</td>'.$CR;
		}
