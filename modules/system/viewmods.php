<?php /* SYSTEM $Id: viewmods.php,v 1.1 2009-05-19 21:15:45 pkerestezachi Exp $*/
...
$titleBlock = new CTitleBlock( 'Modules', 'modules.gif', $m, "$m.$a" );
$titleBlock->addCrumb( "?m=system", "system admin" );
$titleBlock->show();
?>

<table border="0" cellpadding="2" cellspacing="0" width="98%" class="">
<tr class="tableHeaderGral">
	<th colspan="2"><?php echo $AppUI->_('Module');?></th>
	<th align="center"><?php echo $AppUI->_('Status');?></th>
	<th><?php echo $AppUI->_('Type');?></th>
	<th align="center"><?php echo $AppUI->_('Version');?></th>
	<th><?php echo $AppUI->_('Menu Text');?></th>
	<th><?php echo $AppUI->_('Menu Icon');?></th>
	<th><?php echo $AppUI->_('Menu Status');?></th>
    <th><?php echo $AppUI->_('Menu Order');?></th>
</tr>
<?php
...
foreach ($modules as $row) {
	...
	$s .= '<td align="center">'.$row['mod_version'].'</td>';
...
//	$s .= $row['mod_ui_active'] ? '<span style="color:green">'.$AppUI->_('on') : '<span style="color:red">'.$AppUI->_('off');
	...
	$s .= '<td align="center">'.$row['mod_ui_order'].'</td>';
