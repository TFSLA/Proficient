<?php /* TASKS $Id: newgantt.php,v 1.1 2009-05-19 21:15:46 pkerestezachi Exp $ */

/*
 * Gantt.php - by J. Christopher Pereira
 * TASKS $Id: newgantt.php,v 1.1 2009-05-19 21:15:46 pkerestezachi Exp $
 */
...
if ($start_date && $end_date) {
	$st_date = new CDate($start_date);
	$ed_date = new CDate($end_date);
	$graph->SetDateRange( 
			mktime_fix(0,0,0,$st_date->getMonth(), $st_date->getDay(),$st_date->getYear()), 
			mktime_fix(0,0,0,$ed_date->getMonth(), $ed_date->getDay(),$ed_date->getYear()));
}
