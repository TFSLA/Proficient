...
<form method="post" action="index.php?m=webtracking&amp;a=bug_actiongroup_page&o=tasks&task_id=<?=$task_id?>&project_id=<?=$obj->task_project?>">
    ...
    <tbody>
      ...
      <td class="form-title" colspan="10" nowrap="nowrap">
		...
		<?php
			...
			$query = "SELECT id, project_id, priority, status, date_format(last_updated,'%d/%m/%Y') as date_update, date_submitted, summary, task_id,category, severity,handler_id,user_username  
			          ...
			          WHERE task_id = '".$task_id."' $query_ord $limit";
		...
		<span class="small">
		   [ <a href="index.php?m=webtracking&a=print_all_bug_page&task_id=<?=$task_id?>&o=tasks"><?=$AppUI->_('print_all_bug_page_link')?></a> ]
		   
		   [ <a href="index.php?m=webtracking&suppressHeaders=yes&a=csv_export&includeajax=0&task_id=<?=$task_id?>&o=tasks"><?=$AppUI->_('csv_export')?></a> ]
		   
		   [ <a href="index.php?m=webtracking&a=bug_report_page&task_id=<?=$task_id?>&project_id=<?=$project_id?>&o=tasks"><?=$AppUI->_('Report Incidence')?></a> ]
		</span>
	  </td>
      ...
      <tr class="row-category">
		 ...
		 <td class="center"  nowrap="nowrap">
		    ...
		    <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=priority&dir=<?=$dir_p?>" style="text-decoration: none;"><font color="#ffffff">P</font>
		 ...
		 <td class="center" width="52" nowrap="nowrap">
		    ...
		    <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=id&dir=<?=$dir_id?>" style="text-decoration: none;"><font color="#ffffff">ID</font>
		 ...
		 <td class="center"  nowrap="nowrap">
			...
			<a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=category&dir=<?=$dir_cat?>" style="text-decoration: none;"><font color="#ffffff"><?=$AppUI->_('category')?></font>
		 ...
		 <td class="center"  nowrap="nowrap">
		    ...
		    <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=severity&dir=<?=$dir_s?>" style="text-decoration: none;"><font color="#ffffff"><?=$AppUI->_('severity')?></font>
		 ...
		 <td class="center" >
		    ...
		    <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=status&dir=<?=$dir_st?>" style="text-decoration: none;"><font color="#ffffff"><?=$AppUI->_('status')?></font>
		 ...
		 <td class="center" nowrap="nowrap">
		   ...
		   <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=last_updated&dir=<?=$dir_lu?>" style="text-decoration: none;"><font color="#ffffff"><?=$AppUI->_('last_updated')?></font>
		 ...
		 <td class="center" width="100%">
		    ...
		    <a href="index.php?m=tasks&a=view&task_id=<?=$task_id?>&tab=<?=$tab?>&sort=summary&dir=<?=$dir_su?>" style="text-decoration: none;"><font color="#ffffff"><?=$AppUI->_('summary')?></font>
      ...
      ?>
        	...
        	<tr bgcolor="<?=$status[$row['status']]['color']?>">
        	  ...
        	  <td>
        	    ...
        	    <? if ($access_level > '25' || $AppUI->user_type == '1'){ ?>
        	    <a href="index.php?m=webtracking&amp;a=bug_update_page&amp;bug_id=<?=$id_string?>&task_id=<?=$task_id?>&o=tasks"><img src="./modules/webtracking/images/update.gif" alt="Actualizar Incidencia" border="0"></a>	
        	  ...
        	  <td align="center">
                 ...
                 <a href="index.php?m=webtracking&a=bug_view_page&bug_id=<?=$id_string?>&task_id=<?=$task_id?>"><?=$id_string?></a>
        	  </td>
        	  ...
        	  <td align="center">
        	     <?
        	        ...
        	        if($cant[0] > 0){
        	        echo "<a href=\"index.php?m=webtracking&a=bug_view_page&task_id=$task_id&bug_id=$id_string#bugnotes\">".$cant[0]."</a>";
        	        }
        	  ...
        	  <td align="center"> 
        	     <?
        	        ...
        	        if($cant_files[0]>0){
        	        	echo "<a href=\"index.php?m=webtracking&a=bug_view_page&task_id=$task_id&bug_id=$id_string#attachments\">";
              ...
              <td align="right" colspan="12">
			        ...
			        <table border="0">
			           <tr>
						  ...
						  <td class="right" >
							 <span class="small">
							    <?php  print_page_links( "index.php?m=tasks&a=view&task_id=$task_id&tab=$tab", 1, $page_count, $page_number ) ?>
							 </span>
						  </td>
			           </tr>    
			        </table>
