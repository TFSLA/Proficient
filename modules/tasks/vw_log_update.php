<?php /* TASKS $Id: vw_log_update.php,v 1.1 2009-05-19 21:15:46 pkerestezachi Exp $ */
...
if ($task_log_id) {
	...
	if ($log->task_log_creator != $AppUI->user_id && $AppUI->user_type != 1){
		$canEdit = false;
	}
} else {
	...
	<td>
		<table>
		   <tr>
		      <td>
<?php
	echo arraySelect( $percent, 'task_manual_percent_complete', 'size="1" class="text"', $obj->task_manual_percent_complete ) . '%';
?>
		      </td>
		      <td valign="middle" >
			<?php
