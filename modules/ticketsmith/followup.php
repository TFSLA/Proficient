<?php /* TICKETSMITH $Id: followup.php,v 1.1 2009-05-19 21:15:46 pkerestezachi Exp $ */
$ticket = dPgetParam( $_GET, 'ticket', '' );
$ticket_type = dPgetParam( $_GET, 'ticket_type', '' );

// setup the title block
$titleBlock = new CTitleBlock( 'Post Followup', 'tickets.gif', $m, "$m.$a" );
