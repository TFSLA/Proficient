...
<br />
<div align="center">
<form method="post" action="index.php?m=webtracking&a=account_prof_add">
...
<tr>
	...
	<td class="right">
		<?php print_account_menu( 'index.php?m=webtracking&a=account_prof_menu_page' ) ?>
	</td>
</tr>
<tr class="row-1">
	...
	<td width="75%">
		<input type="text" class="text" name="platform" size="32" maxlength="32" />
	</td>
</tr>
<tr class="row-2">
	<td class="category">
	...
	<td>
		<input type="text" class="text" name="os" size="32" maxlength="32" />
	</td>
</tr>
<tr class="row-1">
	<td class="category">
	...
	<td>
		<input type="text" class="text" name="os_build" size="16" maxlength="16" />
	</td>
</tr>
<tr class="row-2">
	<td class="category">
...
<br />
<div align="center">
<form method="post" action="index.php?m=webtracking&a=account_prof_edit_page">
<table class="width75" cellspacing="1">
<tr>
