...
<?php
	...
	if ( ADVANCED_ONLY == config_get( 'show_view' ) ) {
		print_header_redirect ( 'index.php?m=webtracking&a=bug_view_advanced_page&bug_id=' . $f_bug_id );
	}
...
<tr>
	...
	<?php if ( BOTH == config_get( 'show_view' ) ) { ?>
		<span class="small"><?php print_bracket_link( 'index.php?m=webtracking&a=bug_view_advanced_page&bug_id=' . $f_bug_id, lang_get( 'view_advanced_link' ) )?></span>
	<?php }?>
