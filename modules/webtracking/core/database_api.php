<?php
	...
	function db_connect_bt( $p_hostname, $p_username, $p_password, $p_port ) {
	...
	function db_pconnect_bt( $p_hostname, $p_username, $p_password, $p_port ) {
		global $g_db_connected;
	...
	function db_query( $p_query, $p_error_on_failure=true ) {
		...
		$t_result = mysql_query( $p_query )or die (mysql_error());
...
*/
	...
	if ( !isset( $g_skip_open_db ) ) {
		if ( OFF == $g_use_persistent_connections ) {
			db_connect_bt( $g_hostname, $g_db_username, $g_db_password, $g_port );
		} else {
			db_pconnect_bt( $g_hostname, $g_db_username, $g_db_password, $g_port );
		}
