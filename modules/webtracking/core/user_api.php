<?php
	...
	function user_is_name_unique( $p_username ) {
		...
		$query = "SELECT user_username as username
				FROM $t_user_table
				WHERE user_username='$c_username'
				LIMIT 1";
	...
	function user_create( $p_username, $p_password, $p_email='', $p_access_level=null, $p_protected=false, $p_enabled=true ) {
		...
		$query = "INSERT INTO $t_user_table
				    ( user_id, user_username, user_email, user_password, date_created, last_visit,
...
*/
	...
	function user_get_field( $p_user_id, $p_field_name ) {
		$p_field_name_ori = $p_field_name;
		if($p_field_name == "id") $p_field_name = "user_id";
		if($p_field_name == "email") $p_field_name = "user_email";
		if($p_field_name == "username") $p_field_name = "user_username";
		if($p_field_name == "password") $p_field_name = "user_password";
