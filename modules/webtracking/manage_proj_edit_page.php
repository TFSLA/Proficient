...
<?php print_manage_menu( 'index.php?m=webtracking&a=manage_proj_edit_page' ) ?>
...
<!-- PROJECT PROPERTIES -->
<div align="center">
<form method="post" action="index.php?m=webtracking&a=manage_proj_update">
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td width="75%">
		<?php echo string_attribute( $row['name'] ) ?>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<input type="text" class="text" name="file_path" size="50" maxlength="250" value="<?php echo string_attribute( $row['file_path'] ) ?>" />
	</td>
</tr>
<?php } ?>
<?*/?>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<?php echo string_textarea( $row['description'] ) ?>
	</td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td>
		<input type="submit" class="buttonbig" value="<?php echo lang_get( 'update_project_button' ) ?>" />
	</td>
</tr>
</table>
</form>
...
<div class="border-center">
	<form method="post" action="index.php?m=webtracking&a=manage_proj_delete">
		<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
...
?>
		<tr class="row-category">
			...
			<td class="center">
				<?php echo lang_get( 'default_category' ) ?>
			</td>
		</tr>
<?php
	}
		...
		<tr <?php echo helper_alternate_class() ?>>
			...
			<td class="center">
				<?php
					...
					print_bracket_link( 'index.php?m=webtracking&a=manage_proj_cat_edit_page&project_id=' . $f_project_id . '&amp;category=' . $t_name, lang_get( 'edit_link' ) );
					echo ' ';
					print_bracket_link( 'index.php?m=webtracking&a=manage_proj_cat_delete&project_id=' . $f_project_id . '&amp;category=' . $t_name, lang_get( 'delete_link' ) );
				?>
			</td>
			<td class="center" >
			    <? if($t_category['default_category']){ $cheked = "checked"; }else{ $cheked = ""; } ?>
			    <input type="radio"  value="1"  <?=$cheked?> onclick=" default_category_check('<?=$t_name?>')">
			</td>
		</tr>
<?php
	} # end for loop
?>
<!-- Formulario de poner categoria por defecto -->
<form method="post" action="index.php?m=webtracking&a=manage_proj_cat_def"  name="frm_cat_default">
	<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
	<input type="hidden"  name="default_category_name" value="">
</form>

<script language="javascript">
         function default_category_check(val)
         {
         	var f = document.frm_cat_default;
         	
         	f.default_category_name.value = val;
         	f.submit();
         }
</script>
...
<tr>
	<td class="left" colspan="3">
		<form method="post" action="index.php?m=webtracking&a=manage_proj_cat_add">
			<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
			<input type="text" class="text" name="category" size="32" maxlength="64" />
			<input type="submit" class="buttonbig" value="<?php echo lang_get( 'add_category_button' ) ?>" />
		</form>
	</td>
</tr>
...
<tr>
	<td class="left" colspan="3">
		<form method="post" action="index.php?m=webtracking&a=manage_proj_cat_copy">
			<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
			<select name="other_project_id">
				<?php print_project_option_list( null, false ) ?>
			</select>
			<input type="submit" class="buttonbig" name="copy_from" value="<?php echo lang_get( 'copy_categories_from' ) ?>" />
			<input type="submit" class="buttonbig" name="copy_to" value="<?php echo lang_get( 'copy_categories_to' ) ?>" />
		</form>
	</td>
</tr>
</table>
		...
		<tr <?php echo helper_alternate_class() ?>>
			...
			<td class="center">
				<?php
					...
					print_bracket_link( 'index.php?m=webtracking&a=manage_proj_ver_edit_page&project_id=' . $f_project_id . '&amp;version=' . $t_name . '&amp;date_order=' . $t_date_order, lang_get( 'edit_link' ) );
					echo '&nbsp;';
					print_bracket_link( 'index.php?m=webtracking&a=manage_proj_ver_delete&project_id=' . $f_project_id . '&amp;version=' . $t_name . '&amp;date_order=' . $t_date_order, lang_get( 'delete_link' ) );
				?>
			</td>
		</tr>
<?php
...
<tr>
	<td class="left" colspan="3">
		<form method="post" action="index.php?m=webtracking&a=manage_proj_ver_add">
			<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
			<input type="text" class="text" name="version" size="32" maxlength="64" />
			<input type="submit" class="buttonbig" value="<?php echo lang_get( 'add_version_button' ) ?>" />
		</form>
	</td>
</tr>
</table>
...
?>
	...
	?>
			<tr <?php echo helper_alternate_class() ?>>
				...
				<td>
<form method="post" action="index.php?m=webtracking&a=manage_proj_custom_field_update">
	<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
	<input type="hidden" name="field_id" value="<?php echo $t_field_id ?>" />
	<input type="text" class="text" name="sequence" value="<?php echo custom_field_get_sequence( $t_field_id, $f_project_id ) ?>" size="2" />
	<input type="submit" class="button" value="<?php echo lang_get( 'update' ) ?>" />
				...
				<?php
					...
					print_bracket_link( "index.php?m=webtracking&a=manage_proj_custom_field_remove&field_id=$t_field_id&amp;project_id=$f_project_id", lang_get( 'remove_link' ) );
				?>
				</td>
			</tr>
	<?php
	...
	<tr>
		<td class="left" colspan="3">
			<form method="post" action="index.php?m=webtracking&a=manage_proj_custom_field_add_existing">
			<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
...
<br />
<div align="center">
	<form method="post" action="index.php?m=webtracking&a=manage_proj_user_add">
		<input type="hidden" name="project_id" value="<?php echo $f_project_id ?>" />
		<table class="width75" cellspacing="1">
			<tr>
			...
			<?php
				...
				if ( access_has_project_level( config_get( 'project_user_threshold' ), $f_project_id ) ) {
					if ( project_includes_user( $f_project_id, $t_user['id'] )  ) {
						print_bracket_link( 'index.php?m=webtracking&a=manage_proj_user_remove&project_id=' . $f_project_id . '&amp;user_id=' . $t_user['id'], lang_get( 'remove_link' ) );
					}
				}
			?>
			</td>
