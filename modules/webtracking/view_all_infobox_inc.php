...
<?php # -- ====================== FILTER FORM ========================= -- ?>
<br />
<form method="post" action="index.php?m=webtracking&a=view_all_set&f=3">
...
<tr>
	...
	<td>
		<input type="text" class="text" name="highlight_changed" size="3" maxlength="7" value="<?php echo $t_filter['highlight_changed'] ?>" />
	</td>
...
<tr>
	...
	<td class="right" colspan="2">
		<input type="submit" class="button" name="filter" value="<?php echo lang_get( 'filter_button' ) ?>" />
	</td>
</tr>
</table>
</form>
