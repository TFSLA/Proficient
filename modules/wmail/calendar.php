...
include("./modules/wmail/lang/".$my_prefs["lang"]."dates.inc");
include("./modules/wmail/lang/".$my_prefs["lang"]."calendar.inc");
include("./modules/wmail/include/icl.inc");
include("./modules/wmail/include/version.inc");
include("./modules/wmail/conf/defaults.inc");
include("./modules/wmail/include/calendar.inc");
...
if ($edit_cal || $delete_cal){
	include("./modules/wmail/include/edit_calendar.inc");
}
...
if (!isset($current_ts)) $current_ts = mktime_fix(0, 0, 0, $current_month, $current_day, $current_year);
...
<form method="POST" action="calendar.php">
	...
	<?php
	for ($i=1;$i<=12;$i++) echo "<option value=\"$i\">".$lang_months[$i]."\n";
	?>
	</select>
	<select name="go_year">
	<?php
...
$month = $prev_month;
$year = $prev_year;
include("./modules/wmail/include/display_monthly_calendar.inc");
