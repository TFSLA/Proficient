...
include("./modules/wmail/include/nocache.inc");
...
function saveFolderStates($folders){
	...
	$result = cache_write($loginID, $host, "folder_states", $folders);
	return $result;
}
...
if (isset($user)){
	...
	include_once("./modules/wmail/include/stack.inc");
...
<?php
	...
	//show heading
	include("./modules/wmail/lang/".$my_prefs["lang"]."folders.inc");
	...
	if ($my_prefs["show_quota"]=="f"){
		...
		include_once("./modules/wmail/lang/".$my_prefs["charset"].".inc");
