...
if ((isset($session)) && ($session != "")){
	...
	*/
    ...
    if (($my_prefs["list_folders"]==1) && ($port!=110)){
		...
		include_once("./modules/wmail/miniinbox2.php");
		//include_once("./modules/wmail/include/optionfolders.inc.php");
...
if (!$login_success){
	...
	<?
	  ...
	  $user = $users[0]["user_email_user"];
	?>
	<tr><td align=right><?php echo $loginStrings[0] ?>:</td><td><input type="text" name="user" value="<?php echo $user; ?>" size=25></td></tr>
	<tr><td align=right><?php echo $loginStrings[1] ?>: </td><td><input type="password" name="password" value="" size=25 AUTOCOMPLETE="off"></td></tr>
	<?php
