<?php
global $show_quota, $my_prefs, $int_lang, $session;
/////////////////////////////////////////////////////////
//	
//	source/prefs.php
//
...
$user    = $session;
	...
	include("./modules/wmail/include/langs.inc");
	include_once("./modules/wmail/include/icl.inc");
		
	include_once("./modules/wmail/conf/defaults.inc");
	include_once("./modules/wmail/lang/".$lang."prefs.inc");

	//include("./modules/wmail/include/pref_header.inc");
	...
	*/
	...
	?>
		...
		<form method="post" action="?m=wmail&tab=4&a=bridge&session=<?=$user?>&folder=<?=$folder?>" target="_top">
		...
		<table width="100%">
			...
			<td width="50%">
				...
				<p><font size="-1">
				<?php
				$ident_link = "<a href=\"?m=wmail&tab=3&a=bridge&session=$user\">".$prefHeaderStrings[3]."</a>";
				...
				<br><?php //echo $prefsStrings["2.13"]?><a href="?m=wmail&tab=0&a=bridge&session=<?php echo $user?>&folder=INBOX&MOVE_FIELDS=1" target=_blank>
		...
		-->
			...
			<td width="50%">
				...
				<br><input type=checkbox name="show_sig1" value=1 <?php echo ($my_prefs["show_sig1"]==1?"CHECKED":""); ?>>
