...
{
?>
<body link="#333333" vlink="#333333" class="mainpage" background="images/background-intranet.jpg">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/header-bckg.gif">
        ...
        <tr> 
          ...
          <td width="42%" rowspan="2">
              ...
              <tr> 
                <th colspan="2"><font color="#FFFFFF"><?php 
			            	echo $AppUI->_("Candidates Portal");
			            ?></font></th>
              </tr>
            </table></td>
          <td width="19%" rowspan="2" align="right" nowrap="nowrap">
        	
          	<a href="javascript:window.print();"><img src="images/buttons/header-print<?=$sufixlang?>-1.gif" name="print" width="48" height="47" border="0" id="print" onMouseOver="MM_swapImage('print','','images/buttons/header-print<?=$sufixlang?>-2.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
          	<?php /*<a href="#" onClick="javascript:window.open('?m=help&dialog=1&hid=', 'contexthelp', 'width=400, height=520, left=50, top=50, scrollbars=yes, resizable=yes')"><img src="images/buttons/header-help<?=$sufixlang?>-1.gif" name="help" width="48" height="47" border="0" id="help" onMouseOver="MM_swapImage('help','','images/buttons/header-help<?=$sufixlang?>-2.gif',1)" onMouseOut="MM_swapImgRestore()"></a>*/ ?>
          	<a href="hhrr/index.php?logout=-1"><img src="images/buttons/header-signout<?=$sufixlang?>-1.gif" name="signout" width="48" height="47" border="0" id="signout" onMouseOver="MM_swapImage('signout','','images/buttons/header-signout<?=$sufixlang?>-2.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
          </td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
...
if ( $AppUI->user_id == $delegator_id )
{
	...
	foreach ($nav as $module) 
	{
		...
		{*/
			$s .= '<tr>'
				.'  <td class="raya-abajo-item" nowrap="nowrap">';
			...
			$s .='  <a href="hhrr/?a='.$moduledir.'">'
				.strtoupper($AppUI->_($module['mod_ui_name']))
