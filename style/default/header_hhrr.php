<?php /* STYLE/DEFAULT $Id: header_hhrr.php,v 1.1 2009-05-19 21:15:50 pkerestezachi Exp $ */
...
<body link="#333333" vlink="#333333" onload="this.focus();">
		       ...
		       $nav = $AppUI->getMenuModules();
				...
				{   
					...
					{*/
						...
						$links[] = '<a href="hhrr/index.php?a='.$moduledir.'">'.$AppUI->_($module['mod_ui_name']).'</a>';
					//}
				}
				$links[] = '<a href="hhrr/index.php?logout=-1">'.$AppUI->_("hhrrLogout").'</a>';
				echo implode( ' | ', $links );
			}
			else
			{
				...
				{
					$links[] = '<a href="hhrr/index.php?a='.$module['mod_directory'].'&delegator_id='.$delegator_id.'">'.$AppUI->_($module['mod_ui_name']).'</a>';				
				}
				$links[] = '<a href="hhrr/index.php?logout=-1">'.$AppUI->_("hhrrLogout").'</a>';
				echo implode( ' | ', $links );
			}
...
/*
					...
					{
						?>
					<a href="hhrr/index.php?logout=-1"><?php echo $AppUI->_('Logout');?></a>
						<?
					}
					else
					{
